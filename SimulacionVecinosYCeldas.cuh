...
__global__ void AceleracionesfFuerzasLJVYC(int np,const double *p,int chp,double *param,double3 caja,double3 cajai,int3 condper,double *epot,double *a,int *vec,unsigned int *nvec,int nmaxvec,double rc,bool nconf)
{
...
void SimulacionVYC(int np,int nd,double *p,double *v,double *a,double sig,double eps,double3 caja,
